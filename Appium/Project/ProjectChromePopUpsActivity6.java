...
public class ProjectChromePopUpsActivity6 extends ActionBaseScroll{
	...
	//test function
			...
			public void scrollToLoginForm() {
				...
				Point end = new Point((int) (dims.getWidth() * .49), (int) (dims.getHeight() * .3));
				
				doScroll(driver, start, end, 2000);
				
				//PopUps
				
				driver.findElement(AppiumBy.xpath("//android.view.View[@content-desc='Popsups']")).click();
			...
			public void loginwithInValidCred() {
				...
				driver.findElement(AppiumBy.xpath("//android.webkit.WebView[@text='Popups']/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.widget.EditText[2]")).sendKeys("password1");
